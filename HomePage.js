...
let text = document.querySelectorAll('.landing .box .text');

let lengthItems = items.length - 1;
let active = 0;

next.onclick = function(){
    active = active + 1 <= lengthItems ? active + 1 : lengthItems--  ;
    reloadSlider();
}
...
const login = document.getElementById('three');
const signup = document.getElementById('four');
